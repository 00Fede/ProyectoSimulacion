function Yesti = vecinosCercanos(Xval,Xent,Yent,k)
    ...
    % >>>>>>>>> 2� Aqui se calcula las distancias para saber la separacion de todo con todos
    ...
    % Alli desgloso cada una de las partes de estas instrucciones.
     ...
     % >>>>>>>>> 3� Determino los vecinos
     
     % ============ Nota ============
     % Transpongo la matriz dis antes de ordenarla porque
     % as� en cada fila me quedaran las distancias de cada
     ...
     % pero solo las primera K columnas. Donde K seran los K m�s
     % cercanos para cada muestra de validacion.
     indices = indices(:, 1:k);
     
     
    % >>>>>>>>> 4� Por ultimo, calculo el Y*
    % ============ Nota ============
